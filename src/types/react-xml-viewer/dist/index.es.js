  ...
  for (var key in attributes) {
    attributeList.push(
      React.createElement(
        ...
        React.createElement("span", { style: { color: theme.attributeKeyColor } }, " " + key),
        React.createElement("span", { style: { color: theme.separatorColor } }, "="),
        React.createElement("span", { style: { color: theme.attributeValueColor } }, '"' + attributes[key] + '"')
      )
    )
  }

  return React.createElement("span", { style: overflow }, attributeList)
}
...
var DeclarationElement = function DeclarationElement(_ref) {
  ...
  return React.createElement(
    ...
    null,
    React.createElement("span", { style: { color: theme.separatorColor } }, "<?"),
    React.createElement("span", { style: { color: theme.tagColor } }, "xml"),
...
var CdataElement = function CdataElement(_ref) {
  ...
  return React.createElement("div", { style: { color: theme.cdataColor } }, indentation + "<![CDATA[" + cdata + "]]>")
}
...
var CommentElement = function CommentElement(_ref) {
  ...
  return React.createElement("div", { style: { color: theme.commentColor } }, indentation + "<!-- " + comment + " -->")
}
...
var InstructionElement = function InstructionElement(_ref) {
  ...
  return React.createElement(
    "div",
    null,
    React.createElement("span", { style: { color: theme.separatorColor } }, indentation + "<?"),
    React.createElement("span", { style: { color: theme.tagColor } }, name),
    React.createElement("span", { style: { color: theme.attributeKeyColor } }, " " + instruction),
    React.createElement("span", { style: { color: theme.separatorColor } }, "?>")
  )
}
...
var TextElement = function TextElement(_ref) {
  ...
  var overflow = theme.overflowBreak ? { overflowWrap: "break-word", whiteSpace: "normal" } : {}
  return React.createElement("span", { style: _extends({ color: theme.textColor }, overflow) }, text)
}
...
var Element = memo(function (_ref) {
  ...
  return React.createElement(
    ...
    React.createElement("span", { style: { color: theme.separatorColor } }, elements ? ">" : "/>"),
    elements &&
      !collapsed &&
      React.createElement(
        "span",
    ...
    elements && React.createElement("span", { style: { color: theme.tagColor } }, name),
    elements && React.createElement("span", { style: { color: theme.separatorColor } }, ">")
  )
})
...
var defaultInvalidXml = React.createElement("div", null, "Invalid CDA!")
...
var XMLViewer = function XMLViewer(_ref) {
  ...
  return React.createElement(
    ...
    props,
    json.declaration &&
      React.createElement(DeclarationElement, { theme: customTheme, attributes: json.declaration.attributes }),
    React.createElement(Elements, {
