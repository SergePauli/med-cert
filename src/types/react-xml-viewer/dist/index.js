...
function writeAttributes(attributes, options, depth) {
  ...
  for (key in attributes) {
    if (attributes.hasOwnProperty(key) && attributes[key] !== null && attributes[key] !== undefined) {
      ...
      attr = attr.replace(/"/g, "&quot;")
      attrName =
        "attributeNameFn" in options ? options.attributeNameFn(key, attr, currentElementName, currentElement$1) : key
      ...
      result.push(
        attrName +
          ...
          ("attributeValueFn" in options
            ? options.attributeValueFn(attr, key, currentElementName, currentElement$1)
            : attr) +
          quote
      )
    }
...
function writeInstruction(instruction, options, depth) {
  ...
  var instructionName =
    "instructionNameFn" in options
      ? options.instructionNameFn(key, instruction[key], currentElementName, currentElement$1)
      : key
  if (typeof instruction[key] === "object") {
    ...
    if ("instructionFn" in options)
      instructionValue = options.instructionFn(instructionValue, key, currentElementName, currentElement$1)
...
function writeComment(comment, options) {
  return options.ignoreComment
    ? ""
    : "<!--" +
        ("commentFn" in options ? options.commentFn(comment, currentElementName, currentElement$1) : comment) +
        "-->"
}
...
function writeCdata(cdata, options) {
  return options.ignoreCdata
    ...
    : "<![CDATA[" +
        ("cdataFn" in options
          ? options.cdataFn(cdata, currentElementName, currentElement$1)
          : cdata.replace("]]>", "]]]]><![CDATA[>")) +
        "]]>"
}
...
function writeDoctype(doctype, options) {
  return options.ignoreDoctype
    ? ""
    : "<!DOCTYPE " +
        ("doctypeFn" in options ? options.doctypeFn(doctype, currentElementName, currentElement$1) : doctype) +
        ">"
}
...
var Attributes = function Attributes(_ref) {
  ...
  for (var key in attributes) {
    attributeList.push(
      React__default.createElement(
        ...
        React__default.createElement("span", { style: { color: theme.attributeKeyColor } }, " " + key),
        React__default.createElement("span", { style: { color: theme.separatorColor } }, "="),
        React__default.createElement(
          "span",
  ...
  return React__default.createElement("span", { style: overflow }, attributeList)
}
...
var DeclarationElement = function DeclarationElement(_ref) {
  ...
  return React__default.createElement(
    ...
    null,
    React__default.createElement("span", { style: { color: theme.separatorColor } }, "<?"),
    React__default.createElement("span", { style: { color: theme.tagColor } }, "xml"),
...
var InstructionElement = function InstructionElement(_ref) {
  ...
  return React__default.createElement(
    "div",
    null,
    React__default.createElement("span", { style: { color: theme.separatorColor } }, indentation + "<?"),
    React__default.createElement("span", { style: { color: theme.tagColor } }, name),
    React__default.createElement("span", { style: { color: theme.attributeKeyColor } }, " " + instruction),
    React__default.createElement("span", { style: { color: theme.separatorColor } }, "?>")
  )
}
...
var TextElement = function TextElement(_ref) {
  ...
  var overflow = theme.overflowBreak ? { overflowWrap: "break-word", whiteSpace: "normal" } : {}
  return React__default.createElement("span", { style: _extends({ color: theme.textColor }, overflow) }, text)
}
...
var Element = React.memo(function (_ref) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement("span", { style: { color: theme.separatorColor } }, elements ? ">" : "/>"),
    elements &&
      !collapsed &&
      React__default.createElement(
        "span",
        { onClick: onSelectText },
        React__default.createElement(Elements, {
          elements: elements,
          theme: theme,
    ...
    elements && React__default.createElement("span", { style: { color: theme.tagColor } }, name),
    elements && React__default.createElement("span", { style: { color: theme.separatorColor } }, ">")
  )
})
...
var getElement = function getElement(theme, indentation, indentSize, collapsible) {
  return function (element, index) {
    switch (element.type) {
      ...
      case "comment":
        return React__default.createElement(CommentElement, {
          key: "el-" + index,
      ...
      case "cdata":
        return React__default.createElement(CdataElement, {
          key: "el-" + index,
          cdata: element.cdata,
          theme: theme,
          indentation: indentation,
      ...
      case "instruction":
        return React__default.createElement(InstructionElement, {
          key: "el-" + index,
...
var defaultInvalidXml = React__default.createElement("div", null, "Невалидный формат СЭМД!")
...
var XMLViewer = function XMLViewer(_ref) {
  ...
  return React__default.createElement(
    ...
    props,
    json.declaration &&
      React__default.createElement(DeclarationElement, { theme: customTheme, attributes: json.declaration.attributes }),
    React__default.createElement(Elements, {
