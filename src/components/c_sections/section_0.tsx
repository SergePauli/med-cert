...
import { Card } from 'primereact/card'
 ...
 const Section0: FC = () => {
   ...
   const cert_number = certificateStore.number()
  return (<>    
        ...
        <h5>Сведения о документе</h5>
          ...
          <div className="p-field p-col-12 p-md-6">
            <label htmlFor="lastname6">Номер</label>
              <InputText id="lastname6" value={cert_number} disabled type="text" placeholder='Заполняется автоматически'/>
          </div>
          <div className="p-field p-col-12 p-md-6">
            <label htmlFor="state">Вид свидетельства</label>
              <Dropdown inputId="state"  placeholder="Выбрать" autoFocus 
                  ...
                  value={certificateStore.cert_type()}
                  onChange={(e) =>certificateStore.setCert_type(e.value)}/>
            </div>
            <div className="p-field p-col-12 p-md-6">                    
